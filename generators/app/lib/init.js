...
module.exports = ({author, github, name}) => {
  ...
  console.log(`Created module`, chalk.yellow(`'${name}'`), `with generator-module-extended-boilerplate`);
  console.log();

  console.log(`use`, chalk.cyan(`npm run build:watch`), `/`, chalk.cyan(`npm run test:watch`), `for development mode`);

  console.log(`use`, chalk.cyan(`npm run build`), `for production builds (ES2015, CommonJS, UMD, SASS)`);
